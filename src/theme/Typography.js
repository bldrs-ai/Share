...
export function getTypography() {
  return {
    ...
    overline: {fontSize, lineHeight: '24px', letterSpacing, fontWeight},
    caption: {fontSize, lineHeight: '24px', letterSpacing, fontWeight},
    button: {fontSize, lineHeight: '24px', letterSpacing, fontWeight},
    subtitle1: {fontSize, lineHeight: '24px', letterSpacing, fontWeight},
    subtitle2: {fontSize, lineHeight: '24px', letterSpacing, fontWeight},
    textPrimary: {fontSize, lineHeight: '24px', letterSpacing, fontWeight},
    textSecondary: {fontSize, lineHeight: '24px', letterSpacing, fontWeight},
    textTertiary: {fontSize, lineHeight: '24px', letterSpacing, fontWeight},
