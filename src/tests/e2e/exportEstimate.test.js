...
describe('settledEstimateBytes', () => {
  const draco = estimateKey('draco', false, true)
  const none = estimateKey('none', false, true)
  ...
  it('separates the two figures one estimate produces', () => {
    ...
    const stripped = estimateKey('draco', false, false)
  ...
  it('separates portable from native for one codec', () => {
    ...
    const portable = estimateKey('none', true, true)
