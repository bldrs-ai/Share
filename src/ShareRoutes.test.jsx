...
const tests = [
  ...
  {s: 'http://github.com/org/repo/blob/branch/file.ifc', out: pathBlob},
  {s: 'https://githubcom/org/repo/blob/branch/file.ifc', out: pathBlob},
...
describe('ShareRoutes', () => {
  ...
  test('trimToPath', () => {
    [
      {s: '', err: 'Invalid URL: '},
      {s: 'window', err: 'Invalid URL: window'},
  ...
  test('githubUrlOrPathToSharePath', () => {
    ...
    [
      {s: 'a/b/c', err: 'Invalid URL: a/b/c'},
      {s: 'www.google.com', err: 'Invalid URL: www.google.com'},
      {s: 'http://www.google.com', err: errPrefix + '/'},
      {s: 'http://www.google.com/search', err: errPrefix + '/search'},
    ].concat(tests).forEach((pair) => {
      if (pair.out !== undefined) {
