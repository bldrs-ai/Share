...
export default function About() {
  return (
    <>
      <Helmet>
        <title>Bldrs Announces Launch of Share and the Conway Engine</title>
      </Helmet>
      <Paper variant='page-background' sx={{height: '100vh', overflowY: 'scroll'}}>
        <Paper
          ...
          elevation={2}
          sx={{
            width: {xs: '100%', md: '200px'}, // Full width on mobile, fixed on desktop
            float: {xs: 'none', md: 'left'}, // No float on mobile, float on desktop
            margin: {xs: '0 0 16px 0', md: '0 16px 16px 0'}, // Margin for wrapping
          }}
        >
