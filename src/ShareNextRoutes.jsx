...
import ShareNext from './ShareNext'
 ...
 * @return {object}
 */
export default function ShareNextRoutes({installPrefix, appPrefix}) {
  return (
    <Routes>
...
function Forward({appPrefix}) {
  ...
  useEffect(() => {
    if (location.pathname === appPrefix) {
      ...
      debug().log('ShareNextRoutes#useEffect[location]: forwarding to: ', dest)
