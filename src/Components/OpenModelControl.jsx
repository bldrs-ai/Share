...
function SampleModelFileSelector({setIsDialogDisplayed}) {
  ...
  const handleSelect = (e, closeDialog) => {
    ...
    const modelPath = {
      ...
      1: '/share/v/gh/Swiss-Property-AG/Momentum-Public/main/Momentum.ifc#c:-32.285,-2.12,42.106,-5.29,0.94,0.86',
      ...
      6: '/share/v/gh/OlegMoshkovich/Logo/main/IFC_STUDY.ifc/103/25873/113/122/743#c:182.816,35.074,233.133,15.587,19.012,-11.711',
    }
