...
# (configured in the web UI as `bash scripts/web-setup.sh`), whose filesystem
# result is snapshotted — so a session starts with node_modules already present
# and this hook is a near-instant no-op.
#
